...
## Main Page
st.markdown("# Select a spectral preprocessing method.")
method = st.radio("Select a preprocessing method", ["CWT","SNV","MSC","SG_Smooth","SG_Derivate"],
                  horizontal=True,  label_visibility="hidden")


for key in st.session_state.keys():
    del st.session_state[key]
st.markdown("### Import your NIR spectra.")
